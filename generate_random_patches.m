...
patches_structure=struct('Patches', {patches}, 'HoG_Patches_2x2', patches_HoG2,   'Upper_X',{upper_x},'Upper_Y', {upper_y}); 
end
% 'HoG_Patches_4x4', patches_HoG4,'HoG_Patches_8x8', patches_HoG8,'Patches_PCA', patches_PCA,