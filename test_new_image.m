function test_new_image(cnn_cell, config)
...
parfor pixel_idx = 1:5
        [classified_map, prob_plot] = run_classification_test(config, cnn_cell{pixel_idx}, config.data{7}(pixel_idx), resize_factor);
